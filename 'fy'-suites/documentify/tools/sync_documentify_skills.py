#!/usr/bin/env python3
"""
Copy Documentify hub skills into ``.cursor/skills/`` for Cursor project
skill discovery.

Canonical sources:
``'fy'-suites/documentify/superpowers/<skill-name>/SKILL.md`` Targets:
.cursor/skills/<skill-name>/SKILL.md

Run from repository root after editing any skill under
``'fy'-suites/documentify/superpowers/``:
...
def sync(*, check_only: bool) -> int:
    """Copy Documentify router skills to ``.cursor/skills`` or verify they
    match.
