#!/usr/bin/env python3
"""
Copy Testify hub skills into ``.cursor/skills/`` for Cursor project
skill discovery.

Canonical sources:
``'fy'-suites/testify/superpowers/<skill-name>/SKILL.md`` Targets:
.cursor/skills/<skill-name>/SKILL.md

Run from repository root after editing any skill under
``'fy'-suites/testify/superpowers/``:
...
def sync(*, check_only: bool) -> int:
    """Copy Testify router skills to ``.cursor/skills`` or verify they
    match.
